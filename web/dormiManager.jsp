...
<%
    ...
    if(request.getSession().getAttribute("adminType") != null && !request.getSession().getAttribute("adminType").equals(4))
    {
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        欢迎您：<%=request.getSession().getAttribute("adminUserName")%><span class="caret"></span></a>
...
<div class="container-fluid">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
            <li role="presentation"  class="active"><a href="dormiManager.jsp">住宿信息管理</a></li>
        </ul>
    </div>
